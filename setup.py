...
setup(
    ...
    package_dir={'repex_utils': 'src/radical/repex/repex_utils',
                 ...
                 'amber_kernels_3d_qmmm': 'src/radical/repex/md_kernels/amber_kernels_3d_qmmm',
                 'amber_kernels_3d_mm': 'src/radical/repex/md_kernels/amber_kernels_3d_mm'},
    scripts=[],
    license='LICENSE.txt',
