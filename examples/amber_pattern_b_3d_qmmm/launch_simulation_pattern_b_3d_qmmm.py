...
from amber_kernels_3d_qmmm.kernel_pattern_b_3d_qmmm import AmberKernelPatternB3dQMMM
...
if __name__ == '__main__':
    ...
    md_kernel = AmberKernelPatternB3dQMMM( inp_file, work_dir_local )
