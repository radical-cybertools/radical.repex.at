"""
.. module:: radical.repex.launch_simulation_pattern_a
...
if __name__ == '__main__':
    """Runs RE simulation using pattern-A. 
    ...
    name = 'launcher-tex-pattern-A'
    logger  = rul.getLogger ('radical.repex', name)

    logger.info("************************************************")
    logger.info("*    RepEx simulation: AMBER + RE pattern-A    *")
    logger.info("************************************************")
