"""
.. module:: radical.repex.launch_simulation_scheme_1_amber
...
from amber_kernels_tex.amber_kernel_tex_scheme_2 import AmberKernelTexScheme2
from pilot_kernels.pilot_kernel_scheme_2 import PilotKernelScheme2

#-----------------------------------------------------------------------------------------------------------------------------------

if __name__ == '__main__':
    """Runs RE simulation using scheme 1. 
    ...
    print "*********************************************************************"
    print "*                RepEx simulation: AMBER + RE scheme 1              *"
    print "*********************************************************************"
