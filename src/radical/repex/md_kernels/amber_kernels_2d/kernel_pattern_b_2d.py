"""
.. module:: radical.repex.md_kernels.amber_kernels_2d.kernel_pattern_b_2d
...
import amber_kernels_2d.matrix_calculator_temp_ex
import amber_kernels_2d.matrix_calculator_salt_ex
...
class AmberKernel2DpatternB(MdKernel2d):
    ...
    def prepare_shared_data(self):
        ...
        calc_salt = os.path.dirname(amber_kernels_2d.matrix_calculator_salt_ex.__file__)
        calc_salt_path = calc_salt + "/matrix_calculator_salt_ex.py"
        ...
        self.shared_files.append("matrix_calculator_salt_ex.py")
        ...
        calc_salt_url = 'file://%s' % (calc_salt_path)
        self.shared_urls.append(calc_salt_url)
