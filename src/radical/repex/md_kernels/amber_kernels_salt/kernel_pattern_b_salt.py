"""
.. module:: radical.repex.md_kernles.amber_kernels_salt.kernel_pattern_b_salt
...
class KernelPatternBSalt(object):
    ...
    def __init__(self, inp_file,  work_dir_local):
        ...
        if 'exchange_replica_mpi' in inp_file['input.MD']:
            if inp_file['input.MD']['exchange_replica_mpi'] == 'True':
